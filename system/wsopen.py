...
# from system.prefs.appearanceprefswindow import AppearancePrefsWindow
# from system.prefs.arcadeprefswindow import ArcadePrefsWindow
# from system.prefs.controllerprefswindow import ControllerPrefsWindow
# from system.prefs.directoryprefswindow import DirectoryPrefsWindow
# from system.prefs.filedatabaseprefswindow import (
#     FileDatabasePrefsWindow,
# )
# from system.prefs.gamedatabaseprefswindow import (
#     GameDatabasePrefsWindow,
# )
# from system.prefs.keyboardprefswindow import KeyboardPrefsWindow
# from system.prefs.localeprefswindow import LocalePrefsWindow
# from system.prefs.loggingprefswindow import LoggingPrefsWindow
# from system.prefs.midiprefswindow import MidiPrefsWindow
# from system.prefs.mouseprefswindow import MousePrefsWindow
# from system.prefs.netplayprefswindow import NetPlayPrefsWindow
# from system.prefs.openglprefswindow import OpenGLPrefsWindow
# from system.prefs.openretro.openretroprefswindow import (
#     OpenRetroPrefsWindow,
# )
# from system.prefs.overscanprefswindow import OverscanPrefsWindow
# from system.prefs.pluginprefswindow import PluginPrefsWindow
# from system.prefs.powerprefswindow import PowerPrefsWindow
# from system.prefs.screenmodeprefswindow import ScreenModePrefsWindow
# from system.prefs.soundprefswindow import SoundPrefsWindow
# from system.prefs.videoprefswindow import VideoPrefsWindow
# from system.prefs.whdloadprefswindow import WHDLoadPrefsWindow
# from system.prefs.workspaceprefswindow import WorkspacePrefsWindow
from system.tools.calculator import CalculatorWindow
from system.tools.databaseupdater import DatabaseUpdaterWindow
from system.tools.filescanner import FileScannerWindow
from system.utilities.checksum import ChecksumWindow
from system.utilities.clock import ClockWindow
from system.utilities.multiview import MultiView, MultiViewWindow
...
def wsopen(name: str, args=None, *, window=None, parent=None):
    ...
    #     return wsopen_prefs_window(name_lower, window=window)
        ...
        try:
            ...
            #     "/", "."
            # )
            module_name = name_lower.replace(":", ".").replace("/", ".")
