...
class RealWindow(QMainWindow):
    ...
    def set_position_and_size(self, position, size):
        # FIXME: We should do similar calculations as in set_size?
        # Move out to common function
...
class Window(QObject):
    ...
    def active(self):
        return self._real_window.isActiveWindow()
    ...
    def set_position_and_size(self, position, size):
        self._real_window.set_position_and_size(position, size)
